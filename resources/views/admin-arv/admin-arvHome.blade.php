    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div class="grid grid-cols-4 gap-4 mb-4">
                <div
                    class="relative flex items-center justify-center h-24 rounded bg-gradient-to-r from-cyan-500 to-blue-500 dark:bg-gray-800">
                    <p class="absolute top-0 mr-4 text-6xl text-white dark:text-gray-500">
                        {{ $arv->count() }}</p>
                    <div class="absolute bottom-0 right-0 mb-1 mr-2">
                        <a class="text-2xl text-white dark:text-white">ARV</a>
                    </div>
                    <div class="absolute left-0 ml-2 text-white">
                        <svg class="h-24 w-24" viewbox="-2 -6 56 48" version="1.1" id="Layer_1"
